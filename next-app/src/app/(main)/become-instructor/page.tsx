...
export const metadata = {
    title: "Become an Instructor | Tirwin Talent",
};
        ...
        <div className="instructor-landing">
            ...
            <section className="hero">
                <div className="hero-content">
                    ...
                    <img
                        src="/assets/images/hero-instructor.png"
            ...
            <section className="reasons">
                ...
                <div className="reasons-list">
                    <div className="reason">
                        <img src="/assets/images/teach-your-way.svg" alt="Teach your way" />
                        <h4>Teach your way</h4>
                        <p>
                            Publish the courses you want, in the way you want, and always have
                            control of your own content.
                        </p>
                    </div>
                    <div className="reason">
                        <img src="/assets/images/inspire-learners.svg" alt="Inspire learners" />
                    ...
                    <div className="reason">
                        <img src="/assets/images/get-rewarded.svg" alt="Get rewarded" />
                        <h4>Get rewarded</h4>
                        <p>
            ...
            <section className="stats">
                <div className="stat">
                    <span>73M</span> Students
                </div>
                <div className="stat">
                    <span>75+</span> Languages
                </div>
                <div className="stat">
                    <span>1B</span> Enrollments
                </div>
                <div className="stat">
                    <span>180+</span> Countries
                </div>
                <div className="stat">
                    <span>16,000+</span> Enterprise customers
                </div>
            </section>

            {/* How to Begin Section */}
            <section className="how-to-begin">
                <h2>How to begin</h2>
                <div className="steps-tabs">
                    <span className="active">Plan your curriculum</span>
                ...
                <div className="how-content">
                    ...
                    <img
                        src="/assets/images/how-to-begin.svg"
            ...
            <section className="testimonial">
                <div className="testimonial-content">
                    <img
                        src="/assets/images/testimonial-person.png"
                        alt="Instructor testimonial"
                        className="testimonial-img"
                    />
                    <blockquote>
                        <p>
                            &quot;I&apos;m proud to wake up knowing my work is helping people around
                            the world improve their careers and build great things. While being a
            ...
            <section className="support">
                <div className="support-content">
                    <img src="/assets/images/support-team.svg" alt="Support team" />
                    <div>
