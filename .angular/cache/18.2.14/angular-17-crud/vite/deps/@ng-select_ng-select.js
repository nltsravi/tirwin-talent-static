...
function NgSelectComponent_ng_container_4_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(1, NgSelectComponent_ng_container_4_div_1_ng_template_1_Template, 3, 2, "ng-template", null, 1, ɵɵtemplateRefExtractor)(3, NgSelectComponent_ng_container_4_div_1_ng_template_3_Template, 0, 0, "ng-template", 20);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    ...
    ɵɵadvance(3);
    ɵɵproperty("ngTemplateOutlet", ctx_r3.labelTemplate || defaultLabelTemplate_r5)("ngTemplateOutletContext", ɵɵpureFunction3(4, _c6, item_r3.value, ctx_r3.clearItem, item_r3.label));
  }
}
function NgSelectComponent_ng_container_4_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainerStart(0);
    ɵɵtemplate(1, NgSelectComponent_ng_container_4_div_1_Template, 4, 8, "div", 18);
    ɵɵelementContainerEnd();
  }
  if (rf & 2) {
...
function NgSelectComponent_5_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, NgSelectComponent_5_ng_template_0_Template, 0, 0, "ng-template", 20);
  }
  if (rf & 2) {
    const ctx_r3 = ɵɵnextContext();
    ɵɵproperty("ngTemplateOutlet", ctx_r3.multiLabelTemplate)("ngTemplateOutletContext", ɵɵpureFunction2(2, _c7, ctx_r3.selectedValues, ctx_r3.clearItem));
  }
}
...
function NgSelectComponent_ng_container_9_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainerStart(0);
    ɵɵtemplate(1, NgSelectComponent_ng_container_9_ng_template_1_Template, 1, 0, "ng-template", null, 2, ɵɵtemplateRefExtractor)(3, NgSelectComponent_ng_container_9_ng_template_3_Template, 0, 0, "ng-template", 23);
    ɵɵelementContainerEnd();
  }
  if (rf & 2) {
...
function NgSelectComponent_span_10_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementStart(0, "span", 25)(1, "span", 26);
    ɵɵtext(2, "×");
    ɵɵelementEnd()();
  }
  if (rf & 2) {
...
function NgSelectComponent_ng_dropdown_panel_13_div_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(1, NgSelectComponent_ng_dropdown_panel_13_div_2_ng_template_1_Template, 1, 2, "ng-template", null, 3, ɵɵtemplateRefExtractor)(3, NgSelectComponent_ng_dropdown_panel_13_div_2_ng_template_3_Template, 0, 0, "ng-template", 20);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    ...
    ɵɵadvance(3);
    ɵɵproperty("ngTemplateOutlet", item_r10.children ? ctx_r3.optgroupTemplate || defaultOptionTemplate_r11 : ctx_r3.optionTemplate || defaultOptionTemplate_r11)("ngTemplateOutletContext", ɵɵpureFunction4(17, _c8, item_r10.value, item_r10, item_r10.index, ctx_r3.searchTerm));
  }
}
...
function NgSelectComponent_ng_dropdown_panel_13_div_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(1, NgSelectComponent_ng_dropdown_panel_13_div_3_ng_template_1_Template, 4, 2, "ng-template", null, 4, ɵɵtemplateRefExtractor)(3, NgSelectComponent_ng_dropdown_panel_13_div_3_ng_template_3_Template, 0, 0, "ng-template", 20);
    ɵɵelementEnd();
  }
  if (rf & 2) {
...
function NgSelectComponent_ng_dropdown_panel_13_ng_container_4_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainerStart(0);
    ɵɵtemplate(1, NgSelectComponent_ng_dropdown_panel_13_ng_container_4_ng_template_1_Template, 2, 1, "ng-template", null, 5, ɵɵtemplateRefExtractor)(3, NgSelectComponent_ng_dropdown_panel_13_ng_container_4_ng_template_3_Template, 0, 0, "ng-template", 20);
    ɵɵelementContainerEnd();
  }
  if (rf & 2) {
...
function NgSelectComponent_ng_dropdown_panel_13_ng_container_5_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainerStart(0);
    ɵɵtemplate(1, NgSelectComponent_ng_dropdown_panel_13_ng_container_5_ng_template_1_Template, 2, 1, "ng-template", null, 6, ɵɵtemplateRefExtractor)(3, NgSelectComponent_ng_dropdown_panel_13_ng_container_5_ng_template_3_Template, 0, 0, "ng-template", 23);
    ɵɵelementContainerEnd();
  }
  if (rf & 2) {
...
function NgSelectComponent_ng_dropdown_panel_13_ng_container_6_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainerStart(0);
    ɵɵtemplate(1, NgSelectComponent_ng_dropdown_panel_13_ng_container_6_ng_template_1_Template, 2, 1, "ng-template", null, 7, ɵɵtemplateRefExtractor)(3, NgSelectComponent_ng_dropdown_panel_13_ng_container_6_ng_template_3_Template, 0, 0, "ng-template", 20);
    ɵɵelementContainerEnd();
  }
  if (rf & 2) {
...
function NgSelectComponent_ng_dropdown_panel_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(2, NgSelectComponent_ng_dropdown_panel_13_div_2_Template, 4, 22, "div", 28)(3, NgSelectComponent_ng_dropdown_panel_13_div_3_Template, 4, 6, "div", 29);
    ɵɵelementContainerEnd();
    ɵɵtemplate(4, NgSelectComponent_ng_dropdown_panel_13_ng_container_4_Template, 4, 4, "ng-container", 11)(5, NgSelectComponent_ng_dropdown_panel_13_ng_container_5_Template, 4, 1, "ng-container", 11)(6, NgSelectComponent_ng_dropdown_panel_13_ng_container_6_Template, 4, 4, "ng-container", 11);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r3 = ɵɵnextContext();
...
var NgItemLabelDirective = class {
  constructor(element) {
...
NgItemLabelDirective.ɵfac = function NgItemLabelDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NgItemLabelDirective)(ɵɵdirectiveInject(ElementRef));
};
NgItemLabelDirective.ɵdir = ɵɵdefineDirective({
...
var NgOptionTemplateDirective = class {
  constructor(template) {
    this.template = template;
  }
};
NgOptionTemplateDirective.ɵfac = function NgOptionTemplateDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NgOptionTemplateDirective)(ɵɵdirectiveInject(TemplateRef));
};
NgOptionTemplateDirective.ɵdir = ɵɵdefineDirective({
...
var NgOptgroupTemplateDirective = class {
  constructor(template) {
    this.template = template;
  }
};
NgOptgroupTemplateDirective.ɵfac = function NgOptgroupTemplateDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NgOptgroupTemplateDirective)(ɵɵdirectiveInject(TemplateRef));
};
NgOptgroupTemplateDirective.ɵdir = ɵɵdefineDirective({
...
var NgLabelTemplateDirective = class {
  constructor(template) {
    this.template = template;
  }
};
NgLabelTemplateDirective.ɵfac = function NgLabelTemplateDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NgLabelTemplateDirective)(ɵɵdirectiveInject(TemplateRef));
};
NgLabelTemplateDirective.ɵdir = ɵɵdefineDirective({
...
var NgMultiLabelTemplateDirective = class {
  constructor(template) {
    this.template = template;
  }
};
NgMultiLabelTemplateDirective.ɵfac = function NgMultiLabelTemplateDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NgMultiLabelTemplateDirective)(ɵɵdirectiveInject(TemplateRef));
};
NgMultiLabelTemplateDirective.ɵdir = ɵɵdefineDirective({
...
var NgHeaderTemplateDirective = class {
  constructor(template) {
    this.template = template;
  }
};
NgHeaderTemplateDirective.ɵfac = function NgHeaderTemplateDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NgHeaderTemplateDirective)(ɵɵdirectiveInject(TemplateRef));
};
NgHeaderTemplateDirective.ɵdir = ɵɵdefineDirective({
...
var NgFooterTemplateDirective = class {
  constructor(template) {
    this.template = template;
  }
};
NgFooterTemplateDirective.ɵfac = function NgFooterTemplateDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NgFooterTemplateDirective)(ɵɵdirectiveInject(TemplateRef));
};
NgFooterTemplateDirective.ɵdir = ɵɵdefineDirective({
...
var NgNotFoundTemplateDirective = class {
  constructor(template) {
    this.template = template;
  }
};
NgNotFoundTemplateDirective.ɵfac = function NgNotFoundTemplateDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NgNotFoundTemplateDirective)(ɵɵdirectiveInject(TemplateRef));
};
NgNotFoundTemplateDirective.ɵdir = ɵɵdefineDirective({
...
var NgTypeToSearchTemplateDirective = class {
  constructor(template) {
    this.template = template;
  }
};
NgTypeToSearchTemplateDirective.ɵfac = function NgTypeToSearchTemplateDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NgTypeToSearchTemplateDirective)(ɵɵdirectiveInject(TemplateRef));
};
NgTypeToSearchTemplateDirective.ɵdir = ɵɵdefineDirective({
...
var NgLoadingTextTemplateDirective = class {
  constructor(template) {
    this.template = template;
  }
};
NgLoadingTextTemplateDirective.ɵfac = function NgLoadingTextTemplateDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NgLoadingTextTemplateDirective)(ɵɵdirectiveInject(TemplateRef));
};
NgLoadingTextTemplateDirective.ɵdir = ɵɵdefineDirective({
...
var NgTagTemplateDirective = class {
  constructor(template) {
    this.template = template;
  }
};
NgTagTemplateDirective.ɵfac = function NgTagTemplateDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NgTagTemplateDirective)(ɵɵdirectiveInject(TemplateRef));
};
NgTagTemplateDirective.ɵdir = ɵɵdefineDirective({
...
var NgLoadingSpinnerTemplateDirective = class {
  constructor(template) {
    this.template = template;
  }
};
NgLoadingSpinnerTemplateDirective.ɵfac = function NgLoadingSpinnerTemplateDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NgLoadingSpinnerTemplateDirective)(ɵɵdirectiveInject(TemplateRef));
};
NgLoadingSpinnerTemplateDirective.ɵdir = ɵɵdefineDirective({
...
var NgDropdownPanelService = class {
  constructor() {
    this._dimensions = {
      itemHeight: 0,
      panelHeight: 0,
...
NgDropdownPanelService.ɵfac = function NgDropdownPanelService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NgDropdownPanelService)();
};
NgDropdownPanelService.ɵprov = ɵɵdefineInjectable({
...
var NgDropdownPanelComponent = class {
...
NgDropdownPanelComponent.ɵfac = function NgDropdownPanelComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NgDropdownPanelComponent)(ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(NgDropdownPanelService), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(DOCUMENT, 8));
};
NgDropdownPanelComponent.ɵcmp = ɵɵdefineComponent({
...
NgOptionComponent.ɵfac = function NgOptionComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NgOptionComponent)(ɵɵdirectiveInject(ElementRef));
};
NgOptionComponent.ɵcmp = ɵɵdefineComponent({
...
NgSelectConfig.ɵfac = function NgSelectConfig_Factory(__ngFactoryType__) {
...
ConsoleService.ɵfac = function ConsoleService_Factory(__ngFactoryType__) {
...
NgSelectComponent.ɵfac = function NgSelectComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NgSelectComponent)(ɵɵinjectAttribute("class"), ɵɵinjectAttribute("autofocus"), ɵɵdirectiveInject(NgSelectConfig), ɵɵdirectiveInject(SELECTION_MODEL_FACTORY), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(ConsoleService));
};
NgSelectComponent.ɵcmp = ɵɵdefineComponent({
  ...
  template: function NgSelectComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      ɵɵtext(3);
      ɵɵelementEnd();
      ɵɵtemplate(4, NgSelectComponent_ng_container_4_Template, 2, 2, "ng-container", 11)(5, NgSelectComponent_5_Template, 1, 5, null, 11);
      ɵɵelementStart(6, "div", 12)(7, "input", 13, 0);
      ...
      ɵɵelementEnd()()();
      ɵɵtemplate(9, NgSelectComponent_ng_container_9_Template, 4, 1, "ng-container", 11)(10, NgSelectComponent_span_10_Template, 3, 1, "span", 14);
      ɵɵelementStart(11, "span", 15);
      ɵɵelement(12, "span", 16);
      ɵɵelementEnd()();
      ɵɵtemplate(13, NgSelectComponent_ng_dropdown_panel_13_Template, 7, 19, "ng-dropdown-panel", 17);
    }
    if (rf & 2) {
...
var NgSelectModule = class {
};
NgSelectModule.ɵfac = function NgSelectModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NgSelectModule)();
};
NgSelectModule.ɵmod = ɵɵdefineNgModule({
  type: NgSelectModule,
...
NgSelectModule.ɵinj = ɵɵdefineInjector({
  providers: [{
